...
$insert = mysqli_query($connection, "INSERT INTO book_table (book_ISBN, book_title, book_author, book_edition, book_releashed_year, book_picture) VALUES ('$ISBN','$title','$author','$edition','$released_year', '$img')");
