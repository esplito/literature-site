...
<body>
	<div class="modal">
        ...
        <div class="form__row">
					...
					<input type="text" placeholder="Skriv bokens ISBN här..." name="register-username">
				</div>
				<div class="form__row">
					<label class="label label--default">Titel</label>
					<input type="text" placeholder="Skriv titeln på boken här..." name="register-username">
				</div>
        <div class="form__row">
          <label class="label label--default">Författare</label>
          <input type="text" placeholder="Skriv bokens författare här..." name="register-username">
        </div>
        <div class="form__row">
          <label class="label label--default">Upplaga</label>
          <input type="text" placeholder="Skriv bokens upplaga här..." name="register-username">
        </div>
        <div class="form__row">
          <label class="label label--default">Utgivningsår</label>
          <input type="text" placeholder="Skriv bokens utgivningsår här..." name="register-username">
        </div>
